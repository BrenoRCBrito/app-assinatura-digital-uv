...
export const textPresets = {
  ...
  link: (theme: Theme) => ({ ...theme.typography.link, color: theme.textSecondary }),
  ...
  supportingCentered: (theme: Theme) => ({
  ...
  choiceChip: (theme: Theme) => ({ ...theme.typography.choiceChip, color: theme.textSecondary }),
  choiceChipSelected: (theme: Theme) => ({ ...theme.typography.choiceChip, color: theme.onPrimary }),
  ...
  stamp: () => ({ fontWeight: '600', fontVariant: ['tabular-nums'], color: FIXED_COLORS.ink }),
